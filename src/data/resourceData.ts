...
export const PLATFORMS: PlatformInfo[] = [
  {
    ...
    fees: '$0.20 listing fee + 6.5% transaction fee (charged in USD)',
  ...
  },
  {
    ...
    fees: '10% fee (free plan) or from $10/mo for lower fees (charged in USD)',
  ...
  },
  {
    ...
    fees: 'Free plan: 5% fee. Plus plan: $29/mo, 2% fee (charged in USD)',
  ...
  },
  {
    ...
    cons: [
      '5% + $0.50 transaction fee (charged in USD)',
      'Newer platform — smaller community',
      'Not ideal for low-priced products',
    ],
    fees: '5% + $0.50 per transaction (charged in USD)',
  ...
  },
  {
    ...
    cons: [
      'Monthly fee from $39/mo (charged in USD)',
  ...
  },
  {
    ...
    fees: 'Hosting cost only (~£4–16/mo)',
...
export const PRICING_TIPS = [
  {
    ...
    body: 'Most new creators underprice. If you spend 6 hours making a template pack, £7 is not fair. Start at £12–20 and see what converts.',
  },
  {
    title: 'Use charm pricing',
    body: '£7, £15, £22, £35, £47 convert better than round numbers. The psychological effect is real.',
  },
  {
    title: 'Bundle for higher AOV',
    body: 'A single template at £7 vs a "5-pack bundle" at £22. Bundles increase average order value dramatically.',
  },
  {
